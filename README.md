...
> _להשלמה לפני ההגשה — צרף כאן:_

- 🎬 **סרטון דמו** (30–60 שניות): לחיצה בפורטל ← האפליקציה נחסמת. `docs/demo.mp4`
- 🖼️ **לוח החירום בפורטל** — `docs/portal-dashboard.png`
- 🖼️ **מסך תחזוקה באפליקציה** — `docs/app-maintenance.png`
---
